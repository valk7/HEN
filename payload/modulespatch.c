...
LV2_PATCHED_FUNCTION(int, modules_patching, (uint64_t *arg1, uint32_t *arg2))
{
	...
	// 3.55 -> 0x29
#if defined(FIRMWARE_4_82) || defined(FIRMWARE_4_84) || defined(FIRMWARE_4_85) || defined(FIRMWARE_4_86) || defined(FIRMWARE_4_87) || defined(FIRMWARE_4_88) || defined(FIRMWARE_4_82DEX) || defined(FIRMWARE_4_84DEX)
	if ((p[0x30/4] >> 16) == 0x13)
#endif
	{	
		#ifdef	DEBUG
